...
<head>
	...
	<title>ShopAddressList EDITION PAGE</title>
...
<div id="container">
	...
	<div class="content">
		...
		<table>
			<tr>
				<td width="30%">SHOP CODE</td>
				<td><input type="text" name="shop_code" disabled="disable" class="text" value="<?php echo set_value('shop_code'); ?>"/></td>
				<input type="text" name="shop_code" value="<?php echo set_value('shop_code', $this->form_data->shop_code); ?>"/>
			</tr>
			<tr>
